...
import { addOne, changeOperation, setTotal,applyNumber,applyMr,memoryClear ,totalClear} from './actions';
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row details">
              <span id="operation">
                <b>Operation:</b> {value.operation}
                </span>
              <span id="memory"><b>Memory:</b> {value.memory}
              </span>
            </div>
            ...
            <div className="row ce_button">
              <CalcButton value={0} onClick={() => dispatchValue(applyNumber(0))} />
